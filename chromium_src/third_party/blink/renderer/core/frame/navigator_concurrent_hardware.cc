...
NavigatorConcurrentHardware::NavigatorConcurrentHardware(LocalFrame* frame)
    : frame_(frame) {}

unsigned NavigatorConcurrentHardware::hardwareConcurrency() const {
  return brave::FarbleNumberOfProcessors(frame_);
}

void NavigatorConcurrentHardware::Trace(Visitor* visitor) {
